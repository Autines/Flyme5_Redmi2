...
#-----------------------------------------------------------------------------
vendor_saved_apps := AntHalService Bluetooth BluetoothExt com.qualcomm.location \
                     ...
                     ProxyHandler Shell DefaultContainerService CMSettingsProvider Stk TimeService qcrilmsgtunnel
...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy com.qti.dpmframework framework services telephony-common wifi-service org.cyanogenmod.platform
...
override_property += \
    ro.flyme.romer=aromer \
    ro.product.model_romer=redmi-2_aromer \
